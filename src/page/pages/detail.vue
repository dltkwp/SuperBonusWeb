                    ...
                    <div class="panel-body">
                      <fieldset class="form-horizontal">
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" placeholder="请输入页面名称" maxlength="12" v-model="detail.title">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-2 control-label">发布时间:</label>
                          <div class="col-sm-6">
                            <date-picker :editable="false" :value="detail.created" format="yyyy/MM/dd" type="date" placement="bottom-end" @on-change="handleChange" placeholder="请选择发布时间" style="width: 200px"></date-picker>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <div class="summernote">
                              <quill-editor v-model="detail.description" style="height:260px;"
                                  ref="myQuillEditor"
                        ...
                        <div class="form-group" style=" margin-top:  82px"  >
                          <div class="col-sm-4 col-sm-offset-2">
                            <button class="btn btn-primary" v-permission="{code:'page_update'}"  type="buttion" @click="saveSubmit">保存</button>
                          </div>
                        </div>
                      </fieldset>
                    </div>
...
export default {
  ...
  methods: {
    ...
    saveSubmit: function() {
      let _this = this;
      let title = _this.detail.title;
      let created = _this.detail.created;
      let description = _this.detail.description;
