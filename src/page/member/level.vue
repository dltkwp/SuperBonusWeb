      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" @click="realRemove" class="btn btn-primary">确定</button>
...
export default {
  ...
  methods: {
    ...
    realRemove: function(){
      let _this = this;
      _this.$axios.delete('levels/' + _this.levelList[_this.curIndex].id).
        then((result)=> {
          _this.levelList.splice(_this.curIndex,1);
